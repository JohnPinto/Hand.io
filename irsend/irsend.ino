...
unsigned int on_18_auto_cool[] = {8900,4500, 500,600, 500,600, 550,1700, 500,
...
unsigned int off[] = {8900,4500, 500,600, 500,600, 550,1700, 500,600, 550,600, 
...
unsigned int on[] = {8900,4500, 500,600, 500,600, 550,1700, 500,600, 550,1700, 
...
void sendIR(int cod){
    switch (cod)
    {
        case 0:
            ...
            irsend.sendRaw(on, sizeof(on) / sizeof(on[0]), freq);
            delay(100);
            break;
        case 1:
            Serial.println("AC OFF");
            irsend.sendRaw(off, sizeof(off) / sizeof(off[0]), freq);
            delay(100);
            break;
        /*case 3:
